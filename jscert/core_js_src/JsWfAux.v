...
Hint Constructors ok_value ok_result ok_scope basic_value.
...
(** The result of scope resolution, if it not null,
...
(** If the result of prototype resolution for [(f,l)] returns a
